...
async function runSearch() {
  ...
  try {
    ...
    results.innerHTML = data.results.length ? data.results.map(renderCard).join('') : '<div class="empty">No se han detectado publicaciones que cumplan los criterios configurados.</div>';
  } catch (error) {
